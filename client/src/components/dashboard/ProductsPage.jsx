...
//                 {/* Product Image */}
//                 <div className="bg-gray-900 border border-gray-700 rounded-lg w-full h-48 flex items-center justify-center mb-3">
...
//                   <div className="font-bold mb-2 text-white text-lg">{product.name || 'No Name'}</div>
//                   <div className="mb-3 text-gray-300 text-sm flex-1">{product.description || 'No Description'}</div>
...
//                   {/* Add to Cart Button */}
//                   <button
//                     className="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded font-semibold w-full mt-auto"
