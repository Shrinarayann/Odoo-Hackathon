...
// import { Plus, ArrowLeft, Menu, Search, ShoppingCart, User } from 'lucide-react';
// import { useNavigate, Link } from 'react-router-dom';
...
//           <div
//             key={product.id}
//             className="bg-gray-800 rounded-xl p-4 shadow relative group transition"
//           >
//             <img
//               src={product.image_url || 'https://via.placeholder.com/150'}
//               alt={product.name}
...
//       try {
//         const response = await fetch('http://localhost:8080/api/v1/products/user', {
//           headers: {
//             'Authorization': `Bearer ${token}`
//           }
//         });
...
//         {products.map(product => (
//             <div key={product._id} className="bg-white/10 backdrop-blur-lg rounded-xl p-4 shadow-lg">
//               <img
...
//                   Edit
//                 </Button>
//                 <Button variant="danger" className="w-full ml-2">
//                   Delete
//                 </Button>
//               </div>
//             </div>
